...
export default function App() {
  ...
  return (
    <Wrapper navbar={isLoggedIn} onPostEvent={openPostEvent} boardLayout={boardLayout} setBoardLayout={setBoardLayout} userEmail={userEmail} onFilterChange={onFilterChange} onLogout={onLogout}>
      {/* Global modal */}
      <CreateEventModal
